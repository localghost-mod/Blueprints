...
namespace Blueprints
{
    ...
    public class Resources
    {
        ...
        private static readonly FieldInfo designator_place_placingRotation_FI = typeof(Designator_Place).GetField("placingRot", BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        public static IntVec3 Offset(IntVec2 size, Rot4 from, Rot4 to)
        {
            ...
            return (GenThing.TrueCenter(IntVec3.Zero, from, size, alt) - GenThing.TrueCenter(IntVec3.Zero, to, size, alt)).ToIntVec3();
        }

        public static IntVec3 CenterPosition(IntVec3 bottomLeft, IntVec2 size, Rot4 rotation) => bottomLeft + new IntVec3((size.x - 1) / 2, 0, (size.z - 1) / 2);
        ...
        public static void SetDesignatorRotation(Designator_Place designator, Rot4 rotation) => designator_place_placingRotation_FI.SetValue(designator, rotation);
    }
}
