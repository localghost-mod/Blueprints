    ...
    public class Command_CreateBlueprintCopyFromSelected : Command
    {
        ...
        public override IEnumerable<FloatMenuOption> RightClickFloatMenuOptions
        {
            get
            {
                ...
                options.Add(
                    new FloatMenuOption(
                        "Fluffy.Blueprints.CreateFromSelection".Translate(),
        ...
        public override GizmoResult GizmoOnGUI(Vector2 topLeft, float maxWidth, GizmoRenderParms parms)
        {
            ...
            var label = "Fluffy.Blueprints.CopyKey".Translate();
            var size = Text.CalcSize(label);
            Widgets.DrawBoxSolid(new Rect(topLeft + new Vector2(3, 3), size + new Vector2(5, 0)), new Color(0f, 0f, 0f, .4f));
